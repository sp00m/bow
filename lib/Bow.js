...
module.exports = class Bow {
  ...
  middleware(version, getUserCriteriaByUserId) {
    const normalizedVersion = normalizeVersion(version);
    assert.nonEmptyString(normalizedVersion, "middleware's version");
    assert.function(getUserCriteriaByUserId, "middleware's getUserCriteriaByUserId");
    this.middlewares.push(deepFreeze(clone({ version: normalizedVersion, getUserCriteriaByUserId })));
    return this;
  }
  ...
  outbound(version, getUserIdByToken, middlewareVersion) {
    ...
    this.outbounds.push(deepFreeze(clone({ version: normalizedVersion, getUserIdByToken, middlewareVersion: normalizedMiddlewareVersion })));
    return this;
  }
