...
module.exports = class Bow {
  ...
  middleware(version, getUserCriteriaByUserId) {
    ...
    this.middlewares.push(deepFreeze(clone({ version: cleanedVersion, getUserCriteriaByUserId })));
    return this;
  }
  ...
  inbound(path, getMessageFromRequestBody, middlewareVersion) {
    ...
    this.inbounds.push(deepFreeze(clone({ path, getMessageFromRequestBody, middlewareVersion: cleanedMiddlewareVersion })));
    return this;
  }
